...
const ShieldIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" width="64" height="64" stroke="currentColor" strokeWidth="1.5">
    ...
    <div className="auth-screen">
      ...
      <div className="banned-container">
        ...
        <p className="banned-description">
          Your Scriptz AI account has been suspended. This action was taken due to a violation of our terms of service.
        </p>
        ...
        <div className="banned-support">
          ...
          <button 
            className="banned-email-btn"
            onClick={handleCopyEmail}
            type="button"
          >
            <MailIcon />
            <span>{supportEmail}</span>
            <span className="banned-copy-hint">
        ...
        <p className="banned-footer">
          We review all appeals. Response time: 24-48 hours
        </p>
      </div>
    </div>
  )
