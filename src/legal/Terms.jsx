      ...
      <div className="legal-inner">
        ...
        <div className="legal-content">
          ...
          <ul>
            ...
            <li>
              Use the Service to generate content that is defamatory, harassing, sexually explicit,
          ...
          <p>
            ...
            to use that content with the Service and to grant us the limited licence described in
            Section 5.
          </p>
          <p>You must not upload content that:</p>
          <ul>
            <li>
              Contains the likeness, face, voice, or other identifying characteristics of any real
              person (other than yourself) without that person's verifiable consent
            </li>
            <li>Depicts minors in any AI‑generation or likeness flow</li>
            <li>
              Infringes any copyright, trademark, right of publicity, right to privacy, or any other
          ...
          <p>
            The Service is intended for <strong>original and authorized content creation</strong>.
            You must not use the Service to:
          </p>
          <ul>
            <li>
              Create, generate, or publish imagery that impersonates, misrepresents, or falsely
              depicts any real public figure, celebrity, private individual, politician, or creator
            </li>
            <li>
          ...
          <p>
            "Character looks" saved in the Service must be built from reference material you own
            (for example, photos of yourself) or from AI‑generated originals that do not resemble a
            specific real individual. Violations of this section are considered a material breach of
            these Terms and may result in immediate account suspension or termination, and we
            reserve the right to report clear cases to the relevant platform or authority.
          </p>
          ...
          <p>
            ...
            subscribing to a paid plan, you agree to pay all applicable fees. Subscription fees are
            billed in advance on a recurring basis (monthly or annually, depending on the plan you
            select) and renew automatically until cancelled. You may cancel at any time from your
          ...
          <p>
            ...
            ), which acts as our Merchant of Record. Paddle collects and remits applicable taxes
          ...
          <p>
            ...
            constitutes acceptance. Refund requests are handled in accordance with our{' '}
          ...
          <p>
            ...
            will be uninterrupted, error-free, or free of harmful components. AI-generated content
            may be inaccurate or unsuitable; you are responsible for reviewing and using such
          ...
          <p>
            ...
            any time for any reason, including breach of these Terms. Upon termination, your right
            to use the Service ceases immediately. Sections that by their nature should survive
