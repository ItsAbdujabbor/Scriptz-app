    ...
    <div className="legal-screen">
      ...
      <div className="legal-inner">
        ...
        <div className="legal-content">
          <p>
            Scriptz AI (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website, applications, and services (the &quot;Service&quot;). By using the Service, you consent to the practices described in this policy.
          </p>
          ...
          <ul>
            <li><strong>Device and log data:</strong> IP address, browser type, operating system, device identifiers, and access times.</li>
            <li><strong>Cookies and similar technologies:</strong> we use cookies and similar technologies to maintain sessions, remember preferences, and analyze usage. You can manage cookie settings in your browser.</li>
          </ul>
          ...
          <ul>
            ...
            <li>Process your requests and deliver AI-generated content (e.g. scripts, thumbnails)</li>
          ...
          <ul>
            <li><strong>Access and portability:</strong> request a copy of the personal data we hold about you.</li>
            <li><strong>Correction:</strong> request correction of inaccurate or incomplete data.</li>
            <li><strong>Deletion:</strong> request deletion of your personal data, subject to legal exceptions.</li>
            <li><strong>Restriction or objection:</strong> object to or request restriction of certain processing.</li>
            <li><strong>Withdraw consent:</strong> where we rely on consent, you may withdraw it at any time.</li>
            <li><strong>Opt out of marketing:</strong> unsubscribe from promotional emails via the link in each email or in your account settings.</li>
          </ul>
          <p>
          ...
          <h2>10. Contact Us</h2>
          <p>
            For questions about this Privacy Policy or our privacy practices, or to exercise your rights, please contact us at the contact information provided in the footer of our website (e.g. support@scriptz.ai or the contact form linked from our site).
          </p>
        </div>
      </div>
    </div>
