        ...
        <div className="onboarding-card">
                ...
                <div className="onboarding-options onboarding-options--grid onboarding-options--cards onboarding-options--niche">
                  {NICHE_KEYS.map((key, i) => {
                    ...
                    return (
                      ...
                      >
                        <span className="onboarding-option-icon-wrap" aria-hidden>
                          <Icon />
                        </span>
          ...
          {step === 5 && (
            <div className="onboarding-card-actions onboarding-card-actions--center">
              <button
                type="button"
                className="onboarding-btn onboarding-btn-primary onboarding-btn--pill onboarding-btn--full"
          ...
          {step < 5 && step !== 4 && (
            <div className="onboarding-card-actions">
              ...
              <button
                type="button"
                className="onboarding-skip onboarding-skip--entire"
                onClick={skipEntireOnboarding}
                title={t.skipEntireOnboardingSub}
              >
