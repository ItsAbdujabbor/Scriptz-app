...
// Batch size is capped at 4 (product decision). The backend still
// accepts up to 6 (le=6 in app/schemas/thumbnail_chat.py) so 4 is
// always valid — this cap is purely a UI limit.
