...
(function () {
  ...
  function run() {
    ...
    var mobileMenu = document.getElementById('header-mobile');
    if (!header) return;
    ...
    var allLinks = header.querySelectorAll('.header-nav-link, .header-mobile-link');
    ...
    function setActive(sectionId) {
      clearActive();
      var navId = SECTION_NAV[sectionId];
      if (!navId) return;

      /* Desktop link */
      var desktopLink = document.getElementById(navId);
      if (desktopLink) desktopLink.classList.add('active');

      /* Mobile link (matches by data-section) */
      var mobileLink = mobileMenu
    ...
    var observed = Object.keys(SECTION_NAV);
    var sectionEls = observed
